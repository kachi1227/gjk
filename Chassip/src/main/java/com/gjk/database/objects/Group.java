...
public class Group extends BaseGroup {
    ...
    public static Group insertOrUpdate(SQLiteOpenHelper dbm, JSONObject json, boolean isLast) throws Exception {
    ...
    public String toString() {
        return String.format(Locale.getDefault(), "#%d: %s: Side-Convos:%s, Whispers:%s", getGlobalId(), getName(),
                getSideChats(), getWhispers());
    }
